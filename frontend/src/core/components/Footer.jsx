            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    <div className="space-y-4">
                        <Link to="/" className="flex items-center gap-2">
                            <div
                                className="w-[30px] h-[30px] bg-[#C8FB4C] rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                Stay<span className="text-[#C8FB4C]">Hive</span>
                        ...
                        <p className="text-sm leading-relaxed">
                            A comprehensive travel and city experience ecosystem — verified stays, rides, chefs, and
                            essential city services, all in one platform.
                        </p>
                        ...
                        <ul className="space-y-2.5 text-sm">
                            {ecosystem.map((item) => (
                                <li key={item.label} className="flex items-center gap-2">
                                    {item.active ? (
                                        <Link to={item.link}
                                              className="text-[#8A8FA8] hover:text-[#FAFAF8] transition-colors">
                                            {item.label}
                                        </Link>
                                    ) : (
                                        <>
                ...
                {/* Bottom bar */}
                <div
                    className="mt-12 pt-6 border-t border-[#1A1D26] flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-[#3A3D48]">
