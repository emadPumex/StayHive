...
const MobileBottomNav = () => {
    ...
    return (
        <div
            className="lg:hidden fixed bottom-0 left-0 right-0 h-16 bg-white border-t border-gray-150 shadow-2xl flex items-center justify-around z-50 px-2 pb-safe-bottom">
