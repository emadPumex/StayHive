...
const SearchBar = ({onSearch, initialSearch = '', initialCountry = '', initialCity = ''}) => {
    ...
    const hasActive = search || country || city;
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-end">
                ...
                <div className="md:col-span-5">
                    ...
                    <div className="relative">
                        <Search
                            className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-[#3A3D48] pointer-events-none"/>
                        <input
                            type="text"
                            value={search}
                ...
                <div className="md:col-span-3">
                    ...
                    <div className="relative">
                        ...
                        <select value={country} onChange={handleCountryChange}
                                className={`${inputCls} pl-10 pr-4 py-2.5 cursor-pointer`}>
                ...
                <div className="md:col-span-3">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            {country && locations.citiesByCountry[country]?.map(m => <option key={m}
                                                                                             value={m}>{m}</option>)}
                        </select>
                    </div>
                </div>
