    ...
    return (
        <div className="min-h-screen flex text-sans antialiased overflow-hidden select-none bg-[#0B0C10]">
            ...
            <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden flex-col justify-between p-12">
                ...
                <div
                    className="absolute inset-0 bg-gradient-to-tr from-[#050608]/90 via-[#0B0C10]/45 to-transparent z-10"/>
            ...
            <span
                className="text-[10px] uppercase font-bold tracking-widest text-[#C8FB4C] bg-[#C8FB4C]/10 px-2 py-0.5 rounded-md">
              Featured Stay
            </span>
                    ...
                    <div className="flex justify-between items-center pt-2 border-t border-white/10">
                        <p className="text-xs text-white/50">From <span
                            className="text-white font-bold text-sm">$480</span>/night</p>
                        <span
                            className="text-[10px] text-white/85 bg-white/10 px-2 py-1 rounded-full border border-white/15">Verified Stay</span>
                    </div>
                </div>
                ...
                <div className="relative z-20 max-w-lg">
                    ...
                    >
                        <div
                            className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-xs font-semibold text-[#C8FB4C] mb-6">
                        ...
                        <p className="text-white/75 text-base leading-relaxed mb-8 font-light">
                            Book unique homes, luxury apartments, private chefs, and travel experiences curated around
                            the world.
                        </p>
                    </div>
                    ...
                    >
                        <div className="space-y-1">
                            <div className="flex items-center gap-2 text-white font-semibold text-sm">
                                <div
                                    className="w-5 h-5 rounded-full bg-[#C8FB4C]/20 flex items-center justify-center border border-[#C8FB4C]/30">
                                    <ShieldCheck className="w-3 h-3 text-[#C8FB4C]"/>
                                </div>
                                <span>Verified</span>
                            </div>
                            <p className="text-[11px] text-white/50 leading-relaxed font-light">100% inspected
                                properties.</p>
                        </div>
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-[11px] text-white/50 leading-relaxed font-light">Book on the spot
                                instantly.</p>
                        </div>
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-[11px] text-white/50 leading-relaxed font-light">Insured &amp; safe
                                checkouts.</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="w-full lg:w-[45%] relative flex items-center justify-center p-6 md:p-12 min-h-screen">
                ...
                <div
                    className="absolute top-[20%] right-[15%] w-72 h-72 rounded-full bg-[#C8FB4C]/10 blur-[100px] pointer-events-none animate-pulse duration-5000"/>
                <div
                    className="absolute bottom-[20%] left-[10%] w-80 h-80 rounded-full bg-blue-500/10 blur-[120px] pointer-events-none animate-pulse duration-7000"/>
                <div
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 rounded-full bg-purple-500/10 blur-[110px] pointer-events-none"/>
                ...
                />
                <div
                    className="lg:hidden absolute inset-0 bg-gradient-to-t from-[#0B0C10] via-[#0B0C10]/90 to-[#0B0C10]/60 pointer-events-none"/>
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-[#8A8FA8] hidden sm:inline">
              Glass Theme
                        ...
                        >
                            {glassTheme === 'dark' ? <Sun className="w-4 h-4 text-[#C8FB4C]"/> :
                ...
                >
                    ...
                    <div className="flex items-center gap-2 mb-8 justify-center">
                        <div
                            className="w-[32px] h-[32px] bg-[#C8FB4C] rounded-lg flex items-center justify-center shadow-lg shadow-[#C8FB4C]/25">
                            <Compass className="w-4.5 h-4.5 text-[#0F1117]"/>
                        </div>
                        <span
                            className={`text-lg font-bold tracking-tight ${glassTheme === 'dark' ? 'text-[#FAFAF8]' : 'text-gray-900'}`}>
              Stay<span className="text-[#C8FB4C]">Hive</span>
                    ...
                    <div className="space-y-3 mb-6">
                        ...
                        <button
                            ...
                            tabIndex={0}
                            onKeyDown={(e) => {
                                if (e.key === 'Enter' || e.key === ' ') handleSocialLogin('Google');
                            }}
                        ...
                        <button
                            ...
                            tabIndex={0}
                            onKeyDown={(e) => {
                                if (e.key === 'Enter' || e.key === ' ') handleSocialLogin('GitHub');
                            }}
                        ...
                        >
                            <div className="flex items-center gap-3">
                                {/* SVG Github Icon */}
                                <svg
                                    className={`w-5 h-5 shrink-0 ${glassTheme === 'dark' ? 'fill-white' : 'fill-gray-900'}`}
                        ...
                        <button
                            ...
                            tabIndex={0}
                            onKeyDown={(e) => {
                                if (e.key === 'Enter' || e.key === ' ') handleSocialLogin('Facebook');
                            }}
