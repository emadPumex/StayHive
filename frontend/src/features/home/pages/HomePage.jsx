            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-semibold px-2 py-1 rounded-full bg-[#1F3B0C] text-[#C8FB4C]">
                  Superhost
                </span>
                </div>
              </div>
          ...
          {ecosystemServices.map((svc) => {
            ...
            return (
                ...
                >
                  {/* Top row */}
                  <div className="flex items-center justify-between">
                    <div className={`w-9 h-9 rounded-lg flex items-center justify-center ${svc.iconBg} ${svc.iconColor}`}>
