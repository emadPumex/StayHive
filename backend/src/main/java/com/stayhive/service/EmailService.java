...
public class EmailService {
    ...
    public void sendListingConfirmationEmail(String toEmail, String propertyName, String token) {
        try {
            ...
            String confirmUrl = "http://localhost:8080/api/properties/verify/confirm?token=" + token;
            String cancelUrl = "http://localhost:8080/api/properties/verify/cancel?token=" + token;
